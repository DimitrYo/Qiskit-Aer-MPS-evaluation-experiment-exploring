...
# Benchmark metadata
BENCHMARK_NAME = 'qiskit_mps_cpu'
BENCHMARK_DESCRIPTION = 'Qiskit Aer - MPS (CPU)'

def benchmark_qiskit_mps_cpu(qubit_range, shots=1024, print_topology=False, circuit_type='qft', 
                           include_init_time=True):
    """
    Benchmarks MPS simulation performance using Qiskit Aer on CPU.
...
if __name__ == '__main__':
    ...
    qiskit_results = benchmark_qiskit_mps_cpu(qubit_range_to_test)

    print("\n--- Qiskit MPS CPU Benchmark Results ---")
