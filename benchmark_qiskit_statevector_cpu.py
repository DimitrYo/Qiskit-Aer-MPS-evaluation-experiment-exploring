...
# Benchmark metadata
BENCHMARK_NAME = 'qiskit_statevector_cpu'
BENCHMARK_DESCRIPTION = 'Qiskit Aer - Statevector (CPU)'

def benchmark_qiskit_statevector_cpu(qubit_range, shots=1024, print_topology=False, circuit_type='qft',
                                   include_init_time=False):
    """
    Benchmarks statevector simulation performance using Qiskit Aer on CPU.
    ...
    """
    # print("--- Running Qiskit Aer Benchmark (CPU) ---")
    results = []
...
if __name__ == '__main__':
    ...
    qiskit_results = benchmark_qiskit_statevector_cpu(qubit_range_to_test)

    print("\n--- Qiskit Statevector CPU Benchmark Results ---")
