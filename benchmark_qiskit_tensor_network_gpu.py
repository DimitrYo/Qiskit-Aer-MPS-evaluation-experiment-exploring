...
# Benchmark metadata
BENCHMARK_NAME = 'qiskit_tensornet_gpu'
BENCHMARK_DESCRIPTION = 'Qiskit Aer - Tensornet (GPU)'

def benchmark_qiskit_tensornet_gpu(qubit_range, shots=1024, print_topology=False, circuit_type='qft',
                                  include_init_time=False):
    """
    Benchmarks tensor network simulation performance using Qiskit Aer on GPU.
...
if __name__ == '__main__':
    ...
    qiskit_results = benchmark_qiskit_tensornet_gpu(qubit_range_to_test)

    print("\n--- Qiskit Tensornet GPU Benchmark Results ---")
